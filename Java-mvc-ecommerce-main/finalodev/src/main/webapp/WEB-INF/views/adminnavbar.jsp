		...
		<div class="d-flex flex-column">
			<div
				...
				<div>
					...
					if (user != null) {
					%>
					<a href="/finalodev/sepet" class="button btn btn-primary pb-3"><i class="fas fa-solid fa-shopping-cart"></i> Sepet</a>
					<a href="/finalodev/profil" class="button btn btn-primary mx-2 pb-3"><i class="fas fa-solid fa-user"></i> Hesabım</a>

					<%
					if (user.getRole().equals("ADMIN")) {
					%>

					<a href="/finalodev/admin" class="button btn btn-primary mx-2 pb-3"><i class="fa-solid fa-user-gear"></i> Yönetici</a>
					<%
					}

					} else {
					%>
					<a href="/finalodev/login" class="button btn btn-primary mx-2 pb-3">Giriş Yap/Üye Ol</a>
					<%
					}
					%>
				</div>
			...
			<div class="container-2 mx-3">
				...
				%>
				<a class="aaaa w-100 btn btn-primary d-flex justify-content-center py-2"
